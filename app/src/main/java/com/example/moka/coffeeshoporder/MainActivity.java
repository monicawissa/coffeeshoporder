package com.example.moka.coffeeshoporder;
...
public class MainActivity extends AppCompatActivity {
    int quantity = 2;
    private CheckBox ChkBx1,ChkBx2 ;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main);
        ChkBx1 = ( CheckBox ) findViewById( R.id.chocolate_checkbox );
    ...
    public void updateInPrice() {
        ...
        TextView summuryTextView = (TextView) findViewById(
                R.id.ordersummarycal);
        summuryTextView.setText("" + price);
